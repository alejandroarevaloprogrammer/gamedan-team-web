...
privacy-aware external embeds, SEO metadata and a production contact
system.
...
-   External media consent controls
...
Third-party media is integrated through a consent system that prevents
external players from loading before the visitor makes a choice.

The consent layer covers:

-   YouTube trailers
-   SoundCloud players
-   Bandcamp players
-   Accept and Reject controls
-   A persistent browser preference
-   Cookie settings for changing the preference later
-   Blocked-media placeholders when external media is not accepted
-   Direct access to the Cookie Policy from the consent banner

Self-hosted media and locally hosted HTML5 games are not blocked by the
external media consent layer.

### Privacy & Cookie Information

The website includes dedicated legal-information routes:
...
The Privacy Policy explains how contact-form information and technical
anti-spam data are handled.

The Cookie Policy explains the use of third-party external media and how
visitors can accept, reject or later change their external-media
preference.

Both routes are included in the generated sitemap.
...
A simplified view of the current project architecture:
...
The structure separates application routes, reusable UI components,
consent components, game data, utility logic, shared styles, type
definitions, brand configuration and static assets.
...
The form includes both client-side and server-side validation, together
with a link to the Privacy Policy explaining how submitted information
is handled.
...
The PHP contact endpoint is deployed separately from the static frontend
...
-   Privacy and Cookie Policy routes included in the sitemap
...
-   Consent-gated third-party media
...
-   Implementing consent-aware third-party media
-   Embedding HTML5 games
-   Implementing dynamic SEO metadata
-   Creating Privacy Policy and Cookie Policy routes
...
privacy-aware media integration, hosting, DNS, email authentication and
deployment workflows interact in a real production environment.
...
Portfolio: [https://alejandroarevalorojas.com](https://alejandroarevalorojas.com)

GitHub: [https://github.com/alejandroarevaloprogrammer](https://github.com/alejandroarevaloprogrammer)

LinkedIn: [https://www.linkedin.com/in/alejandro-ar%C3%A9valo-rojas-755335365/](https://www.linkedin.com/in/alejandro-ar%C3%A9valo-rojas-755335365/)
